...
class BleDeviceInteractor {
  BleDeviceInteractor({
    ...
    subscribeToCharacteristicNeck,
    required Stream<List<int>> Function(QualifiedCharacteristic characteristic)
    subscribeToCharacteristicForehead,
        ...
        _subScribeToCharacteristicNeck = subscribeToCharacteristicNeck,
        _subScribeToCharacteristicForehead = subscribeToCharacteristicForehead,
  ...
  _subScribeToCharacteristicNeck;

  final Stream<List<int>> Function(QualifiedCharacteristic characteristic)
  _subScribeToCharacteristicForehead;
  ...
  Stream<List<int>> subScribeToCharacteristicNeck(
      QualifiedCharacteristic characteristic) {
    _logMessage('Subscribing to: ${characteristic.characteristicId} ');
    return _subScribeToCharacteristicNeck(characteristic);
  }

  Stream<List<int>> subScribeToCharacteristicForehead(
      QualifiedCharacteristic characteristic) {
    _logMessage('Subscribing to: ${characteristic.characteristicId} ');
    return _subScribeToCharacteristicForehead(characteristic);
  }
}